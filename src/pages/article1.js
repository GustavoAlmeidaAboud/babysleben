...
function article1() {
    return (
        <>
          <Articles vid={"https://www.youtube.com/embed/-GertYBBkGE"} title='Der Besafe Schwangerschaftsgurt' text='Der Besafe Schwangerschaftsgurt, ist der beste Gurt auf dem Markt um euer Baby zu schützen. 
